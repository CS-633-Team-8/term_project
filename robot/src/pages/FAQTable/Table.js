    ...
    <div>
      <FullContentWrapper>
        ...
        {props.error ? (
          <WarningBanner
            isOpen
            message="Problem retrieving FAQs from server, check your connection. If problem persists, please open issue in repo."
          />
        ) : null}
        <DynamicTable
...
export default class TablePage extends Component {
  ...
  updateFAQOnServer(data) {
    this.setState({
      updatingOnServer: { updating: true, finished: false, error: false }
    })
    fetch(apiPath, {
      method: "POST",
      ...
      result => {
        this.setState({
          updatingOnServer: { updating: false, finished: result, error: false }
        })
      },
      ...
      error => {
        this.setState({
          updatingOnServer: { updating: false, finished: true, error }
        })
      }
    )
  }
        ...
        cells: [
          ...
          },
          {
            ...
            content: (
              <Button
                appearance="danger"
                onClick={e => this._deleteEntry(index)}
              >
                Delete
              </Button>
            )
