...
const Elephant = () => {
    ...
    return (
      <ElephantWrapper>
        <motion.svg viewBox="0 0 201 179" initial={false} animate={isChecked ? "checked" : "unchecked"} whileHover="hover" whileTap="pressed" width="402" height="358" onClick={() => setIsChecked(!isChecked)}>
          <motion.path d="M127.059,85H100v56.283c0.03,0,0.058-0.002,0.088-0.002c0.048,0-0.088,0.082-0.088,0.082v-0.08
        ...
        C133.239,103.32,130.944,93,127.059,85z" fill="#606F98" />
          <motion.path d="M100,141.283V85H73.584c-3.886,8-6.181,18.479-6.181,29.487c0,1.087,0.026,2.161,0.07,3.231
        ...
        c0-0.018,0.001-0.033,0.002-0.051c0-0.036-0.002-0.072-0.002-0.108C92.499,142.887,95.71,141.305,100,141.283z" fill="#606F98" />
        <motion.path d="M100,141.283V85H73.584c-3.886,8-6.181,18.479-6.181,29.487c0,1.087,0.026,2.161,0.07,3.231
        c0.05,0.01,0.102,0.022,0.151,0.033c0,0-0.074,0.28-0.103,0.807c0.032,0.624,0.06,1.248,0.107,1.865
        c0.017,0.114,0.029,0.223,0.051,0.344C68.814,134.258,73.403,146,80.043,154h1.872h2.248h2.87h2.248H93
        c-0.261-1.091-0.426-2.251-0.477-3.463c-0.01-0.213-0.017-0.424-0.02-0.635c0-0.053-0.005-0.103-0.005-0.155
        c0-0.018,0.001-0.033,0.002-0.051c0-0.036-0.002-0.072-0.002-0.108C92.499,142.887,95.71,141.305,100,141.283z" opacity="0.1" />
        <motion.polygon points="81.915,148.673 81.915,154.317 84.163,154.317 " fill="#83A2BB" />
        <polygon fill="#83A2BB" points="87.033,148.673 87.033,154.317 89.281,154.317 "/>
                    <polygon fill="#83A2BB" points="119.02,148.673 119.02,154.317 116.771,154.317 "/>
                    <polygon fill="#83A2BB" points="113.9,148.673 113.9,154.317 111.653,154.317 "/>
                    <g  className="head">
                        <g>
                            <path fill="#6E7FAD" d="M70.22,98.164c-3.697-19.834-3.361-38.661-3.361-58.494l-0.336,1.009c-0.32-0.929-0.669-1.816-1.035-2.681
            ...
            c0.219-0.088,0.433-0.18,0.638-0.277v0.001C74.804,117.133,71.429,106.021,70.22,98.164z"/>
                            <path opacity="0.1" d="M70.22,98.164c-3.697-19.834-3.361-38.661-3.361-58.494l-0.336,1.009c-0.32-0.929-0.669-1.816-1.035-2.681
            c-0.207-0.489-0.421-0.968-0.644-1.435c-0.015-0.031-0.03-0.062-0.044-0.092c-0.223-0.464-0.453-0.917-0.692-1.358
            c-0.013-0.023-0.026-0.046-0.039-0.07c-1.215-2.225-2.654-4.146-4.369-5.706c-0.07-0.064-0.136-0.133-0.208-0.195
            c-0.245-0.216-0.503-0.415-0.76-0.616c-0.147-0.115-0.291-0.234-0.442-0.344c-0.233-0.17-0.476-0.328-0.718-0.485
            c-0.189-0.124-0.379-0.248-0.574-0.364c-0.23-0.137-0.469-0.264-0.708-0.39c-0.224-0.118-0.45-0.233-0.681-0.342
            ...
            c0.219-0.088,0.433-0.18,0.638-0.277v0.001C74.804,117.133,71.429,106.021,70.22,98.164z"/>
                        ...
                        <path fill="#6E7FAD" d="M133.412,40.679c3.361-9.749,9.076-16.137,20.17-15.801
        ...
        L133.412,40.679z"/>
                        <path fill="#8092C1" d="M138.498,99.08c-5.08,17.951-20.312,27.738-38.177,28.483c-17.865-0.745-33.096-10.532-38.177-28.483
        ...
        C149.704,78.783,143.261,91.937,138.498,99.08z"/>
                        <g>
                            <path fill="#E1E2E3" d="M75.412,104.256c0,0,1.955,13.629-14.182,11.053c0,0,17.007,10.068,21.478-6.963
            C82.708,108.346,81.4,101.314,75.412,104.256z"/>
                            <motion.ellipse transform="matrix(0.7455 0.6665 -0.6665 0.7455 90.7011 -25.7841)" fill="#E1E2E3" cx="79.111" cy="105.867" rx="4.448" ry="2.457"/>
                        </g>
                        <g>
                            <path fill="#E1E2E3" d="M125.524,104.256c0,0-1.955,13.629,14.182,11.053c0,0-17.007,10.068-21.477-6.963
            C118.229,108.346,119.536,101.314,125.524,104.256z"/>
                            <ellipse transform="matrix(-0.7454 0.6666 -0.6666 -0.7454 283.2084 103.5738)" fill="#E1E2E3" cx="121.826" cy="105.867" rx="4.448" ry="2.457"/>
                        </g>
                        <path opacity="0.1" d="M100.25,127.25L100,85V24.856c0-0.003,0.136-0.007,0.088-0.008c-12.5,0.477-24.519,5.364-33.635,13.129
        ...
        C74.375,118,84.625,127.75,100.25,127.25z"/>
                        <g className="handR">
                            <motion.path fill="#93A3C7" d="M144.169,138.84c0-0.182,0.017-0.36,0.032-0.54c-0.828-0.04-1.673-0.063-2.549-0.163
            ...
            C144.408,140.752,144.169,139.82,144.169,138.84z"/>
                            <path fill="#70879E" d="M93.744,86.146c0,0,7.521-6.01,14.034,0.504C107.778,86.649,101.477,82.7,93.744,86.146z"/>
                            <path fill="#70879E" d="M93.846,93.925c0,0,7.023-6.585,14.03-0.607C107.876,93.317,101.283,89.879,93.846,93.925z"/>
                            <path fill="#70879E" d="M94.838,101.987c0,0,5.751-5.978,12.046-1.144C106.884,100.844,101.058,98.175,94.838,101.987z"/>
                            <path fill="#70879E" d="M96.938,110.755c0,0,4.786-6.714,11.678-2.875C108.616,107.88,102.5,106.103,96.938,110.755z"/>
                        </g>
                        <motion.g className="eyeL" initial={{ scale: 1 }} animate={{ scale: 0.1 }}
    transition={{
      delay: 3,
      duration: 0.1,
      ease: "easeOut",
      yoyo: 3
                        ...
                        <motion.g className="eyeR" initial={{ scale: 1 }} animate={{ scale: 0.1,  }}
    transition={{
      delay: 3,
      duration: 0.1,
      ease: "easeOut",
      yoyo: 3
          ...
          <motion.path d="M 0 128.666 L 128.658 257.373 L 341.808 0" transform="translate(54.917 68.947) rotate(-4 170.904 128.687)" fill="transparent" strokeWidth="65" stroke="#7700FF" strokeLinecap="round" strokeLinejoin="round" variants={tickVariants} style={{ pathLength, opacity }} custom={isChecked}/>
        </motion.svg>
      </ElephantWrapper>
    );
};
